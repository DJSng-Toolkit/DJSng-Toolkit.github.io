...
Jericho's Library is the new, permanent home of my resources page, which was present on my site (and prior, on my SpaceHey) for approximately two years.
...
This page does not include anything listed in our game guides, as that's not its purpose. You should still read the main pages if something interests you.
...
- [WinAmp Skin Museum](https://skins.webamp.org/) - Uses Webamp
...
-  **[Pac Man](https://masonicgit.github.io/pacman/)**
...
### More Games
A personal highlight of games I recommend.
